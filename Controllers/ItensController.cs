...
namespace otilio_dotnet.Controllers
{
    public class ItensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Preco,Percentual,Qtd,NotaDeVendaId,ProdutoId")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Preco,Percentual,Qtd,NotaDeVendaId,ProdutoId")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
